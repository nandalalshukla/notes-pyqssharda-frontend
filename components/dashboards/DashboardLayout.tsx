...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      >
        {/* Sidebar Header */}
        <div className="flex items-center justify-between h-16 px-4 border-b border-slate-100 bg-gradient-to-r from-blue-50 to-white">
          {sidebarOpen && (
            <div>
          ...
          <button
            ...
            className="p-2 hover:bg-slate-100 rounded-lg transition-colors hidden md:block text-slate-600"
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  transition-all duration-200 relative group font-medium text-sm
                  ${
                    isActive
