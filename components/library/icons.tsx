// Inline icon set used by the library explore page — kept as simple SVG
// components rather than pulling in an extra icon-library dependency for
// one-off decorative icons.
...
export const PreviousYearQuestionsIcon = ({
  className,
}: {
  className?: string;
}) => (
